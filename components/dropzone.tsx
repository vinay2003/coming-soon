  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className=" bg-background h-72 lg:h-80 xl:h-96 rounded-3xl shadow-md border-secondary border-2 border-separate cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
